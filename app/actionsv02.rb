...
get '/' do
  @finstagram_post_shark = {
    ...
    comments: [{
      username: "sharky_j",
      text: "From Actions.rb Out for the long weekend... too embarrassed to show y'all the beach bod!"
    }]
  }
  ...
  @finstagram_post_marlin = {
    ...
    comments: [{
      username: "marlin_peppa",
      text: "lunchtime from actions.rb! ;)"
    }]
  }

#to_s converts argument to string
  #[finstagram_post_shark, finstagram_post_whale, finstagram_post_marlin].to_s
 # @finstagram_post_shark[:comments][0][:username]
  #[@finstagram_post_shark, @finstagram_post_whale, @finstagram_post_marlin].to_s
  #[@finstagram_post_whale, @finstagram_post_marlin].to_s
